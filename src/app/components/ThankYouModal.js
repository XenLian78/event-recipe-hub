...
export default function ThankYouModal({ brand, onClose }) {
  ...
  return (
    <>
      ...
      <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[500px] bg-white rounded-3xl p-12 shadow-2xl z-50 text-center border border-[#F1F5F9] flex flex-col items-center space-y-8 animate-scaleUp">
